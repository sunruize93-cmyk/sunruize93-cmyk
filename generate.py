...
def gen_header(data):
    ...
    return f'''<svg xmlns="http://www.w3.org/2000/svg" width="840" height="180" viewBox="0 0 840 180">
  <defs>
  ...
  <rect x="1" y="1" width="838" height="178" rx="16" fill="url(#bg)"/>
  <rect x="1" y="1" width="838" height="178" rx="16" fill="none" stroke="#00d4ff" stroke-width="1" class="border"/>
  ...
  <circle cx="120" cy="155" r="0.8" fill="#7c3aed" class="star" style="animation-delay:0.8s"/><circle cx="720" cy="150" r="1" fill="#00d4ff" class="star" style="animation-delay:2.2s"/>

  <!-- Name & Bio -->
  <text x="420" y="48" text-anchor="middle" font-family="\'Segoe UI\',system-ui,sans-serif" font-size="30" font-weight="800" fill="url(#titleG)" filter="url(#glow2)" letter-spacing="2" class="fi">{name}</text>
  <text x="420" y="70" text-anchor="middle" font-family="\'Segoe UI\',system-ui,sans-serif" font-size="13" fill="#8892b0" class="fi" style="animation-delay:0.1s">{bio}</text>

  <!-- Stats row -->
  <g class="fi" style="animation-delay:0.25s">
    <rect x="90" y="96" width="130" height="56" rx="10" fill="rgba(255,215,0,0.04)" stroke="rgba(255,215,0,0.1)" stroke-width="1"/>
    <text x="155" y="119" text-anchor="middle" font-family="\'SFMono-Regular\',Consolas,monospace" font-size="20" font-weight="700" fill="#FFD700" filter="url(#glow)">{stars}</text>
    <text x="155" y="139" text-anchor="middle" font-family="\'Segoe UI\',system-ui,sans-serif" font-size="10" fill="#8892b0" letter-spacing="1">⭐ STARS</text>
  </g>
  <g class="fi" style="animation-delay:0.35s">
    <rect x="240" y="96" width="130" height="56" rx="10" fill="rgba(0,255,136,0.04)" stroke="rgba(0,255,136,0.1)" stroke-width="1"/>
    <text x="305" y="119" text-anchor="middle" font-family="\'SFMono-Regular\',Consolas,monospace" font-size="20" font-weight="700" fill="#00ff88" filter="url(#glow)">{commits}</text>
    <text x="305" y="139" text-anchor="middle" font-family="\'Segoe UI\',system-ui,sans-serif" font-size="10" fill="#8892b0" letter-spacing="1">🔥 COMMITS</text>
  </g>
  <g class="fi" style="animation-delay:0.45s">
    <rect x="390" y="96" width="130" height="56" rx="10" fill="rgba(124,58,237,0.04)" stroke="rgba(124,58,237,0.15)" stroke-width="1"/>
    <text x="455" y="119" text-anchor="middle" font-family="\'SFMono-Regular\',Consolas,monospace" font-size="20" font-weight="700" fill="#7c3aed" filter="url(#glow)">{prs}</text>
    <text x="455" y="139" text-anchor="middle" font-family="\'Segoe UI\',system-ui,sans-serif" font-size="10" fill="#8892b0" letter-spacing="1">🔀 PRs</text>
  </g>
  <g class="fi" style="animation-delay:0.55s">
    <rect x="540" y="96" width="130" height="56" rx="10" fill="rgba(0,212,255,0.04)" stroke="rgba(0,212,255,0.1)" stroke-width="1"/>
    <text x="605" y="119" text-anchor="middle" font-family="\'SFMono-Regular\',Consolas,monospace" font-size="20" font-weight="700" fill="#00d4ff" filter="url(#glow)">{repos}</text>
    <text x="605" y="139" text-anchor="middle" font-family="\'Segoe UI\',system-ui,sans-serif" font-size="10" fill="#8892b0" letter-spacing="1">📦 REPOS</text>
  </g>
</svg>'''
